...
when ODIN_OS == .Windows {
	foreign import Clay "../../build/clay/windows/clay.lib"
} else when ODIN_OS == .Linux {
	foreign import Clay "../../build/clay/linux/clay.a"
} else when ODIN_OS == .Darwin {
	when ODIN_ARCH == .arm64 {
		foreign import Clay "../../build/clay/macos-arm64/clay.a"
	} else {
		foreign import Clay "../../build/clay/macos/clay.a"
	}
} else when ODIN_ARCH == .wasm32 || ODIN_ARCH == .wasm64p32 {
	foreign import Clay "../../build/clay/wasm/clay.o"
}
